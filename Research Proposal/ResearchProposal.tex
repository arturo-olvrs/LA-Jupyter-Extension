...
\subtitle{A Two-Tier Dashboard for Students and Instructors}
...
%% article.
\begin{abstract}
  As programming becomes increasingly integrated into scientific and educational workflows, the need to understand how users interact with computational notebooks has grown. This project introduces a JupyterLab dashboard extension that monitors and visualizes notebook activity, including notebook openings, cell execution outcomes, errors, and retries. The system produces summary statistics and visual timelines that portray how the workflow unfolded. Two complementary versions are proposed: a student version, focused on self-assessment and awareness of their own coding patterns, and a teacher version, designed to reveal common difficulties across learners. To evaluate the effectiveness and usability of these tools, surveys will be conducted with both students and instructors. Together, these approaches provide a richer understanding of problem-solving behaviors within interactive coding environments and evidence of the dashboard's practical value.
\end{abstract}
